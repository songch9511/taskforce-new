...
처음 보는 사람에게 설명할 때는 이 세 장이면 충분합니다. 원본은 [`images/overview.html`](images/overview.html)입니다.

![한눈에 보는 흐름](images/1-한눈에-보는-흐름.png)

![시스템 구성](images/2-시스템-구성.png)

![예시: 금요일에서 월요일로](images/3-예시-금요일-월요일.png)
